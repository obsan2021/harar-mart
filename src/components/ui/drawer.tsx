...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      <div className="mx-auto mb-8 h-1.5 w-[100px] rounded-full bg-muted" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))
...
const DrawerFooter = ({
  ...
  <div
    className={cn("mt-auto flex flex-col gap-sm sm:flex-row sm:justify-end sm:space-x-2", className)}
    {...props}
  />
)
